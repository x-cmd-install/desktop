...
[![x-cmd/install — desktop Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/desktop.svg?lang=zh)](https://x-cmd.com/install/desktop)
...
合计: **274,343** 行代码（覆盖前 5 种语言、共 **1358** 个文件）。
...
- **Star**: 44,583 · **Fork**: 1,774 · **开放 issue**: 9,946 · **贡献者**: 240

## 累计统计

- **发布数**: 191 · **已合并 PR**: 1321 · **开放 PR**: 63 · **已关闭 issue**: 9301 · **开放 issue**: 645 · **提交数**: 7043
...
_数据快照: `data/card/260925.yml` · 2026-09-25T06:20:50Z._
